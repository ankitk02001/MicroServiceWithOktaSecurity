...
import com.ankit.config.intersepter.RestTemplateInterceptor;
...
//    @Bean
//    @LoadBalanced//to balance the load by using thid anotation we can directly use the name service not localho.......
//    public RestTemplate restTemplate(){
//        //Declaring Bean for RestTemplate
